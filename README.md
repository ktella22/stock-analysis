...
Prior to refactoring my code, I started copying the code that was provided in Challenge starter code file. Using the code in the starter file, I selected the correct workspreadsheet to create the required headers that included years of the analysis, ticker array, Total daily volumn and the calculated Retrun values. After that, I followed the directions to add the codes in the required steps. Below is the screenshot of the code for my refactored script. 
